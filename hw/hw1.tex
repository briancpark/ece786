...
% Notes:MUST PRESUME IN ORDER WRITEBACK
% Other things to note
% Since they are fully bypassed, the pipeline can read the operands of the preivous instruction (EX to EX)
% That also means that bypassing eliminates any RAW data hazards
%
%
%
%
